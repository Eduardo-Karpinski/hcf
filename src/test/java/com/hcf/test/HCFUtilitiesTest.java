...
class HCFUtilitiesTest {
    ...
    void testGetElementsBySQL() {
        ...
        var insert1 = "INSERT INTO testentity (id, age, isAdmin, birthDate, name, salary) VALUES(9998, 23, 0, '2000-01-01 00:00:00', 'Test', 1234.10);";
        var insert2 = "INSERT INTO testentity (id, age, isAdmin, birthDate, name, salary) VALUES(9999, 23, 0, '2000-01-01 00:00:00', 'Test', 1234.10);";
    ...
    void testSum() {
        ...
        List<Object> sum = new HCFConnection<>(TestEntity.class).sum(Arrays.asList("salary", "age"),
